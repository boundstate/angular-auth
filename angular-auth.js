(function () {
  ...
  angular.module('boundstate.auth', ['LocalStorageModule', 'ui.router'])
  ...
  function authProvider() {
    ...
    authService.$inject = ['$rootScope', '$state', 'localStorageService'];
    ...
    function authService($rootScope, $state, localStorageService) {
      ...
      function initialize() {
        ...
        token = localStorageService.get(STORAGE_KEY.TOKEN) || null;
        user = localStorageService.get(STORAGE_KEY.USER) || {};
        if (!isGuest()) {
      ...
      function setToken(value) {
        token = value;
        localStorageService.set(STORAGE_KEY.TOKEN, token);
      }
      ...
      function setUser(value) {
        ...
        localStorageService.set(STORAGE_KEY.USER, user);
      }
